...
INSERT INTO users(id, username, name, birthdate, password) values(1, 'user1db', 'Пользователь из БД', TO_DATE('01-12-2000','dd-MM-yyyy'), '$2a$10$W6ZjRcfjPB.VvB5MhLEa0eu2PxCVADb7gCw9weuDC3dkNVSSKaNde');
